...
export const api = {
  stories: {
    ...
    get: (id: string) =>
      request<{ story: Story; characters: Character[]; locations: Location[] }>(
        `/stories/${id}`,
      ),
  ...
  characters: {
    ...
    delete: (storyId: string, charId: string) =>
      request<{ ok: boolean }>(`/stories/${storyId}/characters/${charId}`, {
        method: "DELETE",
      }),
    ...
    initGenesis: (storyId: string, charId: string) =>
      request<Character>(`/stories/${storyId}/characters/${charId}/genesis`, {
        method: "POST",
      }),
  },
  ...
  locations: {
    ...
    delete: (storyId: string, locationId: string) =>
      request<{ ok: boolean }>(`/stories/${storyId}/locations/${locationId}`, {
        method: "DELETE",
      }),
  },
  ...
  fieldDefs: {
    ...
    delete: (storyId: string, defId: string) =>
      request<{ ok: boolean }>(`/stories/${storyId}/field-defs/${defId}`, {
        method: "DELETE",
      }),
  },
