...
export const f = {
	...
	subLabel:
		'text-[10px] font-semibold tracking-[0.04em] uppercase text-text-muted',
	required: 'text-error',
	...
	tagRemove: 'text-[10px] ml-[3px] opacity-70 leading-none hover:opacity-100',
	...
	charRole:
		'text-[10px] text-text-muted max-w-20 overflow-hidden text-ellipsis whitespace-nowrap shrink-0',
