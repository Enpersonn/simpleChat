	...
	async extract(ctx) {
		...
		try {
			...
			if (targetId && data.stateChanges) {
				...
				if (changes.atmosphere)
					override.atmosphere = changes.atmosphere;
				if (changes.soundscape)
					override.soundscape = changes.soundscape;
				if (changes.smells) override.smells = changes.smells;
				if (changes.description)
					override.description = changes.description;
