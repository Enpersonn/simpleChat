...
export const CharacterSchema = z.object({
	...
	name: z.string().min(1),
	private: CharacterPrivateSchema.default(() => ({ fears: [], hiddenEmotionalState: '', moralLimits: '', privateKnowledge: [], trueMotives: '' })),
	public: CharacterPublicSchema.default(() => ({ age: '', appearance: '', clothing: '', gender: '', personality: [], reputation: '', species: 'human', speechStyle: '', voiceNotes: '' })),
