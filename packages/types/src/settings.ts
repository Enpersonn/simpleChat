...
export const ResponseLengthSchema = z.enum(['short', 'medium', 'long', 'paragraph+'])
...
export const DEFAULT_PROMPT_PROFILES: PromptProfile[] = [
  {
    ...
    generationParams: { temperature: 0.85, top_p: 0.9, top_k: 40, repeat_penalty: 1.1 },
  },
  {
    id: 'slow-burn-drama',
    ...
    generationParams: { temperature: 0.8, top_p: 0.9, top_k: 35, repeat_penalty: 1.1 },
  },
  {
    id: 'action-heavy',
    name: 'Action Heavy',
    ...
    generationParams: { temperature: 0.9, top_p: 0.95, top_k: 50, repeat_penalty: 1.05 },
  },
  {
    ...
    moodTags: ['eerie', 'dark'],
    responseLength: 'medium',
    feelText: 'dread through implication, sensory wrongness, no explicit horror',
    generationParams: { temperature: 0.88, top_p: 0.92, top_k: 40, repeat_penalty: 1.15 },
  },
  {
    id: 'storyteller-mode',
    name: 'Storyteller',
    ...
    feelText: 'cinematic narration, balance dialogue and action, end with a hook',
    generationParams: { temperature: 0.85, top_p: 0.9, top_k: 40, repeat_penalty: 1.1 },
  },
]
